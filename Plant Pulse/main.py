...
st.markdown("<h1 style='text-align: center; font-size: 36px; font-weight: bold;'>PLANT PULSE</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    if predictions[0][np.argmax(predictions)]*100 >= 80:
        st.write(f"The leaf is affected by {label_name[np.argmax(predictions)]}")
